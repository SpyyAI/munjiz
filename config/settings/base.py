...
SECRET_KEY = os.environ.get('SECRET_KEY', 'unsafe-default-replace-me')
...
LLM_MODEL_DEFAULT = os.environ.get('LLM_MODEL_DEFAULT', 'qwen/qwen-2.5-72b-instruct:free')
LLM_MODEL_ORCHESTRATOR = os.environ.get('LLM_MODEL_ORCHESTRATOR', LLM_MODEL_DEFAULT)
...
LOGGING = {
    ...
    'loggers': {
        'apps.agents': {'level': 'DEBUG', 'handlers': ['console'], 'propagate': False},
    },
}
